...
export default function FanArtGuidelines() {
  return (
    <div className="bg-white bg-opacity-90 rounded-xl shadow-2xl p-8 max-w-4xl mx-auto my-16">
      ...
      <GuidelineList>
        <GuidelineItem>
          私のアバターはHoneycrisp様の<Link href="https://booth.pm/ja/items/2198694">ユキちゃん</Link>です。
        </GuidelineItem>
        
        <GuidelineItem>
          そのため私は一次創作者ではないのです…<span className="font-bold">が、</span>
        </GuidelineItem>
        ...
        <GuidelineItem>
          宜しければ配信のサムネイルや SNS投稿に使用する可能性があることを了承の上 <Link href="https://x.com/hashtag/yunigraphics">#yunigraphics</Link> のタグ付きで投稿していただけると嬉しいです。
        </GuidelineItem>
